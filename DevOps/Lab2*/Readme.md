...
Мы, конечно, глупенькие котятки, но хранить пароли просто в файлах не будем, доверимся профессионалам. Docker Compose позволяет использовать secrets без необходимости хранить информацию в переменных окружения.
