...
3. Amazon S3
   ...
   Amazon Glacier — это сервис облачного хранения от Amazon Web Services, предназначенный для длительного хранения редко используемых данных. Он предлагает экономически эффективное решение для архивирования, позволяя пользователям хранить большие объемы информации по низкой цене. Время доступа к данным в леднике может варьироваться от нескольких минут до нескольких часов.
