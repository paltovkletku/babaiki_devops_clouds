...
- Azure Sentinel - сервис информационной безопасности (Security information and event management, или SIEM), который находит угрозы безопасности в облаке и локально, и реагирует на них. Сервис полезен для упрощения управления безопасностью и обеспечения защиты от угроз.
